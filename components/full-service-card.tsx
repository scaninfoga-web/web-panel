...
export default function FullServiceCard({
  ...
  return (
    <div className="flex min-h-screen items-center justify-between px-24">
      <div className="flex flex-col space-y-8">
        <h1 className="text-5xl">{spacedTitle}</h1>
        <h2 className="max-w-[35vw] pl-1 text-lg text-white/75">
          {smallDescription}
        </h2>
      </div>
      <div>
