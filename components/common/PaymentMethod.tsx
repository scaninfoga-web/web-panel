      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`flex h-10 w-10 items-center justify-center rounded-lg ${
                paymentMethod === 'card' ? 'bg-teal-500' : 'bg-gray-700'
              }`}
            >
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400">Provides instant credit</p>
              <p className="mt-1 text-xs text-orange-400">
                Note: 2% additional platform fee
              </p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-white">Bank Transfer</h4>
              <p className="text-sm text-gray-400">No additional fees</p>
              <p className="mt-1 text-xs text-blue-400">
                May take 24 hours to provide credit
              </p>
            </div>
          </div>
        </button>
