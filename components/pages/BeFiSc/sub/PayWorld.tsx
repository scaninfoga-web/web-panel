            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-4">
              ...
              <div>
                ...
                <p className="text-base font-medium text-yellow-500">
                  {formatSentence(payworldData?.responseData?.add_bene_by_mpin)}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-base font-medium">
                  <CustomBadge value={payworldData?.responseData?.kyc_status} />
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base font-medium">
                  <CustomBadge value={payworldData?.responseData?.pan_status} />
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base font-medium">
                  <CustomBadge value={payworldData?.responseData?.img_status} />
                </p>
              </div>
