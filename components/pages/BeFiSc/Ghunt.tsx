...
export default function GhuntComponent({
  accountData,
}: {
  accountData: GhuntData | null;
}) {
  if (!accountData) {
    return <></>;
  }
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <InfoText label="User Type" value={accountData.profile.userTypes[0]} />
        <InfoText
          label="Custom Cover"
          value={
            <StatusBadge
      ...
      >
        ...
        <InfoText label="Last Edited" value={accountData.profile.lastEdited} />
        <InfoText
