...
// type Tabs = "Mobile 360" | "Udyam Data"

// export default function Dash() {
//     const [searchQuery, setSearchQuery] = useState('');
//     const [searchFilter, setSearchFilter] = useState<Tabs>("Mobile 360");
...
//                     <p className="mt-2 text-xs text-slate-400">Last Delivery</p>
...
//                       Your email password was found in a data breach. This means
