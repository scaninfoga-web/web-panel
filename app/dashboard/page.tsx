...
export default function Dashboard() {
  ...
  return (
        <div className="container mt-12 mx-auto px-4 py-8 flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="bg-slate-900 border-slate-800 text-white">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Infected Credentials</CardTitle>
                <Lock className="h-4 w-4 text-red-500" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">1</div>
                <p className="text-xs text-slate-400">Last detected: 2 days ago</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <Tabs value={activeTab} className="w-full" onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-5 bg-slate-900 text-white border border-slate-800 rounded-lg h-auto p-1 sm:w-auto sm:grid-cols-5">
              <TabsTrigger
                value="overview"
                className="data-[state=active]:bg-slate-800 data-[state=active]:text-emerald-500 rounded-md"
              >
                Overview
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="overview" className="mt-6">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="bg-slate-900 border-slate-800 text-white col-span-full lg:col-span-2">
                  <CardHeader>
                  ...
                  <CardContent>
                    <ScrollArea className="h-[300px] pr-4">
                      <div className="grid gap-4">
                        {[
                          { name: "Account Details", status: "Secure", icon: User, color: "text-emerald-500" },
                          { name: "Bank Address", status: "Secure", icon: CreditCard, color: "text-emerald-500" },
                          { name: "Employee Status", status: "Verified", icon: Users, color: "text-emerald-500" },
                          { name: "ESIC History", status: "Complete", icon: FileText, color: "text-emerald-500" },
                          { name: "Google Account", status: "Warning", icon: Mail, color: "text-amber-500" },
                          {
                          ...
                          { name: "LPG Gas Info", status: "Verified", icon: Info, color: "text-emerald-500" },
                          {
                          ...
                          { name: "Mobile Details", status: "Secure", icon: Phone, color: "text-emerald-500" },
                          {
                          ...
                          { name: "UAN Passbook", status: "Secure", icon: FileText, color: "text-emerald-500" },
                          { name: "User Attributes", status: "Secure", icon: User, color: "text-emerald-500" },
                          {
                            name: "WhatsApp Data",
                            status: "Secure",
                            icon: MessageSquare,
                          ...
                          { name: "Gmail Data", status: "Warning", icon: Mail, color: "text-amber-500" },
                        ].map((item, index) => (
                          <motion.div
                            key={item.name}
                ...
                <Card className="bg-slate-900 border-slate-800 text-white">
                  <CardHeader>
                    ...
                    <CardDescription className="text-slate-400">Latest security issues detected</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ScrollArea className="h-[300px] pr-4">
                      <div className="space-y-4">
                        ...
                        >
                          ...
                          <div>
                            <p className="font-medium text-red-500">Infected Credentials Detected</p>
                            <p className="text-xs text-slate-400">Your email password was found in a data breach</p>
                        ...
                        >
                          ...
                          <div>
                            <p className="font-medium text-amber-500">Multiple UPI IDs Warning</p>
                            <p className="text-xs text-slate-400">Unusual number of UPI IDs linked to your account</p>
                            <p className="mt-1 text-xs text-slate-500">3 days ago</p>
                          </div>
                        </motion.div>
                        <motion.div
                          initial={{ opacity: 0, y: 10 }}
                        ...
                        >
                          <AlertCircle className="h-5 w-5 text-amber-500" />
                          <div>
                            <p className="font-medium text-amber-500">Google Account Warning</p>
                            <p className="text-xs text-slate-400">Unusual login activity detected</p>
                            <p className="mt-1 text-xs text-slate-500">5 days ago</p>
                          </div>
                        </motion.div>
                      </div>
                    </ScrollArea>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Badge className="mt-1 bg-emerald-500/20 text-emerald-500">Active</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="border-slate-800">
                          ...
                          <TableHead className="text-slate-400">Contribution</TableHead>
                          <TableHead className="text-slate-400">Status</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {[
                          { period: "Jan-Mar 2023", contribution: "₹4,500", status: "Paid" },
                          { period: "Apr-Jun 2023", contribution: "₹4,500", status: "Paid" },
                          { period: "Jul-Sep 2023", contribution: "₹4,500", status: "Paid" },
                          { period: "Oct-Dec 2023", contribution: "₹4,500", status: "Paid" },
                        ].map((item) => (
                          <TableRow key={item.period} className="border-slate-800">
                            <TableCell>{item.period}</TableCell>
                            <TableCell>{item.contribution}</TableCell>
                            <TableCell>
                              <Badge className="bg-emerald-500/20 text-emerald-500">{item.status}</Badge>
                            </TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Badge className="mt-1 bg-emerald-500/20 text-emerald-500">Verified</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-slate-900 border-slate-800 text-white">
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {[
                          { id: "john@hdfcbank", bank: "HDFC Bank", status: "Active" },
                          { id: "john@sbi", bank: "State Bank of India", status: "Active" },
                          { id: "john@icici", bank: "ICICI Bank", status: "Active" },
                          { id: "john@ybl", bank: "Yes Bank", status: "Suspicious" },
                          { id: "john@paytm", bank: "Paytm Payments Bank", status: "Suspicious" },
                        ].map((item) => (
                    ...
                    <div className="mt-4 rounded-lg border border-amber-900/50 bg-amber-950/20 p-3">
                      <p className="text-xs text-amber-500">
                        Warning: Unusual number of UPI IDs detected. Please verify all linked accounts.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">MH/BAN/1234567/000/0000123</p>
                        </div>
                      </div>
                      <Separator className="bg-slate-800" />
                      <Table>
                        ...
                        <TableBody>
                          {[
                            { month: "Mar 2023", contribution: "₹1,800", status: "Credited" },
                            { month: "Feb 2023", contribution: "₹1,800", status: "Credited" },
                            { month: "Jan 2023", contribution: "₹1,800", status: "Credited" },
                            { month: "Dec 2022", contribution: "₹1,800", status: "Credited" },
                          ].map((item) => (
                            <TableRow key={item.month} className="border-slate-800">
                ...
                <Card className="bg-slate-900 border-slate-800 text-white">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-xs text-slate-400">Consumer Number</p>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-2">Last Delivery</p>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <p className="text-xs text-slate-400">Last Password Change</p>
                      ...
                      <div className="rounded-lg border border-amber-900/50 bg-amber-950/20 p-3">
                        <p className="text-xs text-amber-500">
                          Warning: Unusual login activity detected from Mumbai, India on April 15, 2023.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Badge className="bg-emerald-500/20 text-emerald-500">Verified</Badge>
                        </div>
                      </div>
                      <Separator className="bg-slate-800" />
                      <div>
                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                          <Badge className="bg-slate-800 text-white">WhatsApp</Badge>
                          <Badge className="bg-slate-800 text-white">Google</Badge>
                          <Badge className="bg-slate-800 text-white">Banking</Badge>
                ...
                <Card className="bg-slate-900 border-slate-800 text-white">
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {[
                          { email: "john.doe@gmail.com", provider: "Gmail", status: "Primary" },
                          { email: "john.work@gmail.com", provider: "Gmail", status: "Secondary" },
                          { email: "j.doe@outlook.com", provider: "Outlook", status: "Recovery" },
                          { email: "john@company.com", provider: "Exchange", status: "Work" },
                        ].map((item) => (
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between rounded-lg border border-slate-800 bg-slate-950/50 p-3">
                        ...
                        <Badge className="bg-emerald-500/20 text-emerald-500">Secure</Badge>
                      </div>
                      <div className="flex items-center justify-between rounded-lg border border-slate-800 bg-slate-950/50 p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-400">john.doe@gmail.com</p>
                          </div>
                        </div>
                        <Badge className="bg-amber-500/20 text-amber-500">Warning</Badge>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="rounded-lg border border-red-900/50 bg-red-950/20 p-4">
                        <h3 className="text-lg font-semibold text-red-500">Critical Security Alert</h3>
                        <p className="mt-1 text-sm text-slate-400">
                          Your email password was found in a data breach. This means your account may be compromised.
                        </p>
                        <div className="mt-4 grid gap-4 md:grid-cols-2">
                          <div>
                            <p className="text-xs text-slate-400">Affected Account</p>
                            <p className="font-medium">john.doe@gmail.com</p>
                          </div>
                          <div>
                          ...
                          <div>
                            <p className="text-xs text-slate-400">Breach Source</p>
                        ...
                        <div className="mt-4">
                          <Button className="bg-red-500 text-white hover:bg-red-600">Change Password Now</Button>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <p className="font-medium text-emerald-500">Protected</p>
                        </div>
                        <p className="mt-2 text-xs text-slate-400">
                          Your accounts are currently protected against known info stealers.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 rounded-lg border border-amber-900/50 bg-amber-950/20 p-3">
                        <AlertCircle className="h-5 w-5 text-amber-500" />
                        <div>
                          <p className="font-medium text-amber-500">Change Gmail Password</p>
                          <p className="text-xs text-slate-400">Your password was found in a data breach</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 rounded-lg border border-amber-900/50 bg-amber-950/20 p-3">
                        <AlertCircle className="h-5 w-5 text-amber-500" />
                        <div>
                          <p className="font-medium text-amber-500">Verify UPI IDs</p>
                          <p className="text-xs text-slate-400">Remove suspicious UPI IDs from your account</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-slate-800 bg-slate-950/50 p-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-400">Generate and store strong passwords</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
